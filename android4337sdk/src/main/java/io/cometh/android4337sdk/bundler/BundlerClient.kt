...
interface BundlerClient {
    fun ethSendUserOperation(userOperation: io.cometh.android4337sdk.UserOperation, entryPointAddress: String): Request<Any, EthSendUserOperationResponse>
    fun ethEstimateUserOperationGas(userOperation: io.cometh.android4337sdk.UserOperation, entryPointAddress: String): Request<Any, EthEstimateUserOperationGasResponse>
